...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_message_message_component__ = __webpack_require__("../../../../../src/app/components/message/message.component.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_12__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_13__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_14__services_chat_service__["a" /* ChatService */], __WEBPACK_IMPORTED_MODULE_16__guards_auth_guard__["a" /* AuthGuard */]],
...
module.exports = "<h2 class=\"page-header pt-5 text-center text-muted\">chat</h2>\n  <div #scroller class=\"card col-sm-12 offset-sm-0 col-md-10 offset-md-1\" style=\"height: 500px; overflow: auto\">\n    <div id=\"chatmessages\" class=\"card-block\" *ngFor=\"let text of messagefeed | async\">\n      <app-message [chatmessage]=text></app-message>\n    </div>\n  </div>\n<form (submit)=\"onChatmessageSubmit()\" class=\"pt-3\">\n    <div class=\"form-group row\">\n      <input *ngIf=\"authService.loggedIn()\" type=\"text\" [(ngModel)]=\"chatmessage\" autocomplete=\"off\" name=\"chatmessage\" class=\"form-control text-center col-sm-12 offset-sm-0 col-md-4 offset-md-4 bg-light\" id=\"chatmessageInput\" placeholder=\"enter a chat message\">\n      <input *ngIf=\"!authService.loggedIn()\" type=\"text\" class=\"form-control text-center col-sm-12 offset-sm-0 col-md-4 offset-md-4 bg-light\" disabled=\"disabled\" placeholder=\"log in to chat\">\n    </div>\n    <div class=\"form-group row\">\n      <button *ngIf=\"authService.loggedIn()\" type=\"submit\" class=\"col-sm-12 offset-sm-0 col-md-2 offset-md-5 btn btn-light\">submit</button>\n    </div>\n</form>\n"
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.connection = this.chatService.getChatObservable().subscribe(function (data) {
            _this.messagefeed = _this.chatService.getChatMessages();
        });
    };
    ...
    HomeComponent.prototype.onChatmessageSubmit = function () {
        var _this = this;
        if (this.chatmessage && this.chatmessage.length > 0) {
            ...
            this.chatService.saveChatMessage(msg).subscribe(function (data) {
                console.log(data);
                _this.chatService.emitNewMessageAdded(_this.chatmessage);
                _this.chatmessage = '';
            });
        }
        else {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('scroller'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"])
    ], HomeComponent.prototype, "chatCard", void 0);
...
module.exports = "<h2 class=\"page-header pt-5 text-center\">Login</h2>\n<form (submit)=\"onLoginSubmit()\" class=\"pt-3\">\n    <div class=\"form-group row\">\n      <input type=\"email\" [(ngModel)]=\"username\" name=\"username\" class=\"form-control col-sm-12 offset-sm-0 col-md-4 offset-md-4 bg-light\" id=\"usernameInput\" placeholder=\"enter username\">\n    </div>\n    <div class=\"form-group row\">\n      <input type=\"password\" [(ngModel)]=\"password\" name=\"password\" class=\"form-control col-sm-12 offset-sm-0 col-md-4 offset-md-4 bg-light\" id=\"passwordInput\" placeholder=\"enter password\">\n    </div>\n    <div class=\"form-group row\">\n      <button type=\"submit\" class=\"col-sm-12 offset-sm-0 col-md-2 offset-md-5 btn btn-light\">submit</button>\n    </div>\n</form>\n"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show('Login successful', { cssClass: 'alert-success', timeout: 1000 });
...
module.exports = "<div class=\"messagecontainer\">\n  <hr>\n  <strong><font color=\"{{ color }}\" size=\"4\">{{ username }}:</font></strong>\n  <font color=\"#e1e1e1\" size=\"4\">{{ text }}</font>\n</div>\n"
...
var MessageComponent = /** @class */ (function () {
    ...
    MessageComponent.prototype.hashCode = function (str) {
        var hash = 0;
    ...
    MessageComponent.prototype.intToRGB = function (i) {
        var c = (i & 0x00FFFFFF)
            .toString(16)
            .toUpperCase();
...
module.exports = "  <nav class=\"navbar navbar-expand-lg bg-light navbar-light\">\n    <div class=\"container\">\n      <a routerLink=\"/\" class=\"navbar-left\"><img src=\"../../../eye.png\"></a>\n      <a routerLink=\"/\" class=\"navbar-brand pl-2\">sclera</a>\n      <button class=\"navbar-toggler\" data-toggle=\"collapse\" data-target=\"#navbarColor03\">\n        <span class=\"navbar-toggler-icon\"></span>\n      </button>\n      <div class=\"collapse navbar-collapse\" id=\"navbarColor03\">\n        <ul class=\"navbar-nav ml-auto\">\n          <li [routerLinkActiveOptions]=\"{exact:true}\" routerLinkActive=\"active\" class=\"nav-item\">\n            <a routerLink=\"/\" class=\"nav-link\">chat</a>\n          </li>\n          <li *ngIf=\"!authService.loggedIn()\" routerLinkActive=\"active\" class=\"nav-item\">\n            <a routerLink=\"/login\" class=\"nav-link\">login</a>\n          </li>\n          <li *ngIf=\"!authService.loggedIn()\" routerLinkActive=\"active\" class=\"nav-item\">\n            <a routerLink=\"/register\" class=\"nav-link\">register</a>\n          </li>\n          <li *ngIf=\"authService.loggedIn()\" routerLinkActive=\"active\" class=\"nav-item\">\n            <a routerLink=\"/profile\" class=\"nav-link\">profile</a>\n          </li>\n          <li *ngIf=\"authService.loggedIn()\" routerLinkActive=\"active\" class=\"nav-item\">\n            <a routerLink=\"/\" (click)=\"onLogoutClick()\" class=\"nav-link\">logout</a>\n          </li>\n        </ul>\n      </div>\n    </div>\n  </nav>\n"
...
module.exports = "<div *ngIf=\"user\">\r\n  <hr>\r\n  <h2 class=\"page-header text-muted\">username: {{user.username}}</h2>\r\n  <hr>\r\n  <h2 class=\"page-header text-muted\">email: {{user.email}}</h2>\r\n  <hr>\r\n</div>\r\n"
...
module.exports = "<h2 class=\"page-header\">Register</h2>\n<hr>\n<form (submit)=\"onRegisterSubmit()\">\n    <div class=\"form-group\">\n      <label for=\"usernameInput\">username</label>\n      <input type=\"email\" [(ngModel)]=\"username\" name=\"username\" class=\"form-control bg-light\" id=\"emailInput\" placeholder=\"enter username\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"emailInput\">email address</label>\n      <input type=\"text\" [(ngModel)]=\"email\" name=\"email\" class=\"form-control bg-light\" id=\"usernameInput\" placeholder=\"enter email\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"passwordInput\">password</label>\n      <input type=\"password\" [(ngModel)]=\"password\" name=\"password\" class=\"form-control bg-light\" id=\"passwordInput\" placeholder=\"password\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"passwordInput\">confirm password</label>\n      <input type=\"password\" [(ngModel)]=\"password2\" name=\"password2\" class=\"form-control bg-light\" id=\"passwordInput2\" placeholder=\"retype password\">\n    </div>\n    <button type=\"submit\" class=\"btn btn-dark btn-lg\">submit</button>\n  </form>\n"
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('New user registered', { cssClass: 'alert-success', timeout: 1000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessage.show(data.msg, { cssClass: 'alert-danger', timeout: 3000 });
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.findUser = function (user) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('users/finduser', user, { headers: headers })
            .map(function (res) { return res.json(); });
    };
...
var ChatService = /** @class */ (function () {
    ...
    ChatService.prototype.emitNewMessageAdded = function (msg) {
        this.socket = __WEBPACK_IMPORTED_MODULE_3_socket_io_client__('/');
        this.socket.emit('new-message-added', msg);
    };
    ChatService.prototype.getChatObservable = function () {
        var _this = this;
